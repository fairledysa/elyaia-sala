// FILE: apps/merchant/src/boltify/components/ui/Button.tsx
...
const Button = forwardRef<HTMLButtonElement, IButtonProps>((props, ref) => {
	...
	const filteredRest: Record<string, unknown> = { ...rest };
	delete filteredRest.isActive;
	delete filteredRest.isactive;
	delete filteredRest.rightIcon;
	delete filteredRest.righticon;
	...
	const btnVariants: Record<TButtonVariants, Record<TColors, string>> = {
		solid: {
			primary:
				'text-white border-primary-500 bg-primary-500 hover:border-primary-600 hover:bg-primary-600 active:border-primary-600 active:bg-primary-600 data-active:border-primary-600 data-active:bg-primary-600',
			secondary:
				'border-secondary-500 bg-secondary-500 hover:border-secondary-600 hover:bg-secondary-600 active:border-secondary-600 active:bg-secondary-600 data-active:border-secondary-600 data-active:bg-secondary-600 text-primary-950',
			...
			violet:
				'border-violet-500 bg-violet-500 hover:border-violet-600 hover:bg-violet-600 active:border-violet-600 active:bg-violet-600 data-active:border-violet-600 data-active:bg-violet-600 text-zinc-200',
		},
		outline: {
			primary:
				'border-primary-500/50 bg-transparent text-primary-700 hover:border-primary-500 hover:bg-primary-50 active:border-primary-500 data-active:border-primary-500 dark:text-primary-200 dark:hover:bg-primary-950',
			secondary:
				'border-secondary-500/50 bg-transparent text-secondary-700 hover:border-secondary-500 hover:bg-secondary-50 active:border-secondary-500 data-active:border-secondary-500 dark:text-secondary-200 dark:hover:bg-secondary-950',
			...
			violet:
				'border-violet-500/50 bg-transparent text-black hover:border-violet-500 active:border-violet-500 data-active:border-violet-500 dark:text-white',
		},
		default: {
			primary:
			...
			secondary:
				'border-transparent bg-transparent text-secondary-600 hover:text-secondary-500 active:text-secondary-500 data-active:text-secondary-500 dark:hover:text-secondary-400',
			...
			violet:
				'border-transparent bg-transparent text-violet-500 hover:text-violet-400 active:text-violet-400 data-active:text-violet-400 dark:hover:text-violet-400',
		},
		soft: {
			primary:
				'border-transparent bg-primary-500/10 text-primary-600 hover:border-primary-500/20 hover:bg-primary-500/15 active:border-primary-500/20 active:bg-primary-500/15 data-active:border-primary-500/20 data-active:bg-primary-500/15',
			secondary:
				'border-transparent bg-secondary-500/20 text-secondary-700 hover:border-secondary-600/30 hover:bg-secondary-500/30 active:border-secondary-600/30 active:bg-secondary-500/30 data-active:border-secondary-600/30 data-active:bg-secondary-500/30',
			...
			violet:
				'border-transparent bg-violet-500/25 text-violet-500 hover:border-violet-600/50 hover:bg-violet-600/50 active:border-violet-600/50 active:bg-violet-600/50 data-active:border-violet-600/50 data-active:bg-violet-600/50',
		},
		link: {
			primary:
				'border-transparent bg-transparent text-zinc-800 hover:text-primary-500 active:text-primary-500 data-active:text-primary-500 dark:text-zinc-200 dark:hover:text-primary-400 dark:active:text-primary-500 dark:data-active:text-primary-500',
			secondary:
				'border-transparent bg-transparent text-zinc-800 hover:text-secondary-600 active:text-secondary-600 data-active:text-secondary-600 dark:text-zinc-200 dark:hover:text-secondary-400 dark:active:text-secondary-500 dark:data-active:text-secondary-500',
			...
			amber:
				'border-transparent bg-transparent text-zinc-800 hover:text-amber-400 active:text-amber-500 data-active:text-amber-500 dark:text-zinc-200 dark:hover:text-amber-400 dark:active:text-amber-500 dark:data-active:text-amber-500',
			...
			violet:
				'border-transparent bg-transparent text-zinc-800 hover:text-violet-400 active:text-violet-500 data-active:text-violet-500 dark:text-zinc-200 dark:hover:text-violet-400 dark:active:text-violet-500 dark:data-active:text-violet-500',
		},
	};
