// FILE: apps/merchant/src/boltify/components/ui/Badge.tsx
...
const Badge: FC<IBadgeProps> = (props) => {
	...
	const badgeVariant: Record<TBadgeVariants, Record<TColors, string>> = {
		solid: {
			...
			secondary: 'bg-secondary-500 border-transparent text-primary-950',
			zinc: 'bg-zinc-500 border-transparent text-white',
			red: 'bg-red-500 border-transparent text-white',
			amber: 'bg-amber-500 border-transparent text-zinc-900',
			lime: 'bg-lime-500 border-transparent text-zinc-900',
			emerald: 'bg-emerald-500 border-transparent text-white',
			sky: 'bg-sky-500 border-transparent text-white',
			blue: 'bg-blue-500 border-transparent text-white',
			violet: 'bg-violet-500 border-transparent text-white',
		},
		outline: {
			primary: 'border-primary-500 bg-primary-500/10 text-primary-600',
			secondary: 'border-secondary-500 bg-secondary-500/10 text-secondary-700',
		...
		default: {
			...
			secondary: 'text-secondary-700 border-transparent',
		...
		soft: {
			primary: 'text-primary-600 bg-primary-500/10 border-transparent',
			secondary: 'text-secondary-700 bg-secondary-500/20 border-transparent',
