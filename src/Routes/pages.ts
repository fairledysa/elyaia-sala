...
const documentation = {
  exampleMain: {
    id: "documentation",
    to: "/marketing/marketing_tools", // ✅ FIX: كان "marketing/marketing_tools" بدون /
    text: "التسويق",
    icon: "PerplexityAi",
    subPages: {
      gettingStarted: {
...
export { apps, pagesExamples, documentation, examples };
